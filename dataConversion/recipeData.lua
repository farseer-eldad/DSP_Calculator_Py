    ...
    game_techs = {
        {
            ...
            image='1104',
            position={29.0, -27.0},
            description='With the development of chemical science, it is now possible to add hydrogen and coal to Crude Oil, and process more Crude Oil through reforming reaction.',
            conclusion='You have mastered reforming refine technology, and you can produce more Crude Oil for the production of next-level chemical products.',
        },{
            id=1111,
            name='Energy Matrix',
            hash_needed=36000,
            ...
            image='1305',
            position={49.0, -27.0},
            description='With the support of computing power of quantum chips, strange matter can be distributed to specific points. Then the entanglement effect of a single quantum can be amplified to the macromolecular level. With this technology, subverting the tranditional chemical engineering is just a "drop by".',
            conclusion='You have unlocked Mesoscopic quantum entanglement, this would replace tranditional chemical engineering completely. Now you can produce more advanced chemical plant. ',
        },{
            id=1311,
            ...
            image='1608',
            position={25.0, 17.0},
            description='Through Logistics Distributor and Logistics Bots, transporting items between storage and Icarus can be accomplished on the same planet. They can also transport items between storages those are on this planet.',
            conclusion='You have unlocked the Logistics Distributor and Logistics Bots, build it on the top of the storage and put Logistics Bots in it. After setting conditions, they will transport items to other storages or Icarus on this planet.',
        },{
            id=1701,
            ...
            image='2304',
            position={21.0, 17.0},
            description='Increased inventory and logistics list capacity to enable mecha to carry more items.',
            conclusion='You have obtained more Inventory Capacity.',
        },{
            id=2305,
            name='Inventory Capacity',
            ...
            image='3401',
            position={9.0, -31.0},
            description='Increase the flight speed of logistics drones.<br>Increase the flight speed of logistics bots.',
            conclusion='Logistics Drones and Logistics Bots fly faster.',
        },{
            id=3402,
            name='Logistics Carrier Engine',
            hash_needed=108000,
            ...
            image='3403',
            position={17.0, -31.0},
            description='Increase the flight speed of logistics drones.<br>Increase the flight speed of logistics bots.<br>Increases the navigation speed of logistics vessels.',
            conclusion='Logistics Vessels, Logistics Drones and Logistics Bots fly faster.',
        },{
            id=3404,
            name='Logistics Carrier Engine',
            hash_needed=300000,
            ...
            image='3404',
            position={21.0, -31.0},
            description='Increase the flight speed of logistics drones.<br>Increase the flight speed of logistics bots.<br>Increases the navigation speed of logistics vessels.<br>Allows logistics vessels to warp.',
            conclusion='The Logistics Vessel can warp, but need to consume <span style="color:#FD965ECC">Space Warper</span>.<br>Logistics Bots fly faster.',
        },{
            id=3405,
            name='Logistics Carrier Engine',
            hash_needed=360000,
            ...
            image='3501',
            position={9.0, -35.0},
            description='Applying material compression technology to logistics, which greatly increases the carrying capacity of logistics drones.<br>Increases the carrying capacity of logistics bots.',
            conclusion='Logistics Drones and Logistics Bots can transport more cargos each time.',
        },{
            id=3502,
            name='Logistics Carrier Capacity',
            hash_needed=108000,
            ...
            image='3502',
            position={13.0, -35.0},
            description='Increases the carrying capacity of logistics drones.<br>Increases the carrying capacity of logistics bots.',
            conclusion='Logistics Drones and Logistics Bots can transport more cargos each time.',
        },{
            id=3503,
            name='Logistics Carrier Capacity',
            ...
            image='3503',
            position={17.0, -35.0},
            description='Increases the carrying capacity of logistics drones. <br>Increases the carrying capacity of logistics bots.<br>Increases the carrying capacity of logistics vessels.',
            conclusion='Logistics Vessels, Logistics Drones and Logistics Bots can transport more cargos each time.',
        },{
            id=3504,
            name='Logistics Carrier Capacity',
            hash_needed=300000,
            ...
            image='3509',
            position={41.0, -35.0},
            description='Increases the carrying capacity of logistics drones. <br>Increases the carrying capacity of logistics bots.<br>Increases the carrying capacity of logistics vessels.<br>Increase the storage capacity of the logistics stations.',
            conclusion='Logistics Vessels, Logistics Drones and Logistics Bots can transport more cargos each time.<br>Planetary Logistics Station and Interstellar Logistics Station can storge more cargos.',
        },{
            id=3510,
            name='Logistics Carrier Capacity',
            ...
            image='4001',
            position={9.0, -27.0},
            description='Increase the distribution range of logistics bot.',
            conclusion='The range of Logistics Distributor is larger.',
        },{
            id=4002,
            name='Distribution Range',
            hash_needed=108000,
